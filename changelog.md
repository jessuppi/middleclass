...
- added responsive layout primitives including containers, reading widths, stacks, clusters, columns, and logical alignment
...
- added the live demonstration page, MIT license, and usage, customization, accessibility, architecture, sizing, variable, and class documentation
